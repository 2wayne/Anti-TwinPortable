...
user in an INI file next to Anti-TwinPortable.exe called Anti-TwinPortable.ini.
...
copy AppNamePortable.ini from this directory to Anti-TwinPortable.ini next to
Anti-TwinPortable.exe. The options in the INI file are as follows:
